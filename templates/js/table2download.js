    ...
    $.fn.table_download = function( options ) {
        ...
        if (settings.format == "csv") {        
            return this.each(function() {
                ...
                if(options.btn_prepand_class){
                    $("<a class='btn btn-primary table_download_csv_link' href='"+blobURL+"' download='"+fileName+"' export_id='"+export_id+"'>"+settings.linkname+"</a>").appendTo($(options.btn_prepand_class));
                }else{
                    // add the download link
                    $(this).append("<a class='btn btn-primary table_download_csv_link' href='"+blobURL+"' download='"+fileName+"' export_id='"+export_id+"'>"+settings.linkname+"</a>");
                }
