...
class page_test extends \Page {
	...
	function init(){
		...
		$btn->onClick(function()use($email_array,$body){
			...
			// $email_model['Attachments']=json_encode($email_array['attachment']);
